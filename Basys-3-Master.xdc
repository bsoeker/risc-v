...
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports scs];#Sch name = JA2
...
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports reset_slave];#Sch name = JA7
